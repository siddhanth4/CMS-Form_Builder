 ...
 *
 * Admin panel page to:
 *   1. List all grievances filed by Data Principals
...
const GrievancesPage: React.FC = () => {
    ...
    return (
        <div className="app-container">
            ...
            {/* DPDP note */}
            <div className="mb-3 p-3" style={{ background: "rgba(255,193,7,0.06)", borderRadius: 10, border: "1px solid rgba(255,193,7,0.15)", fontSize: 13 }}>
                <i className="bi bi-info-circle me-2 text-warning" />
            ...
            {!loading && filtered.length > 0 && (
                <div className="d-flex justify-content-between align-items-center mt-3 text-secondary small">
                    <span>Showing {filtered.length} of {grievances.length} grievances</span>
                    <div className="d-flex gap-1">
                        <button className="btn btn-sm" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "var(--bs-body-color)" }} disabled><i className="bi bi-chevron-left" /></button>
                        <button className="btn btn-sm" style={{ background: "rgba(79,110,247,0.2)", border: "1px solid rgba(79,110,247,0.3)", color: "#7c9ff7" }}>1</button>
                        <button className="btn btn-sm" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "var(--bs-body-color)" }} disabled><i className="bi bi-chevron-right" /></button>
                    </div>
                </div>
            )}
