...
export type OrgLoginPayload = {
    UserName: string;
    Password: string;
    OrgCode:  string; // ✅ Required by /api/Organization/organizationLogin (see Swagger)
};
...
export const organizationLogin = async (
    ...
    fd.append("UserName", payload.UserName);
    fd.append("Password", payload.Password);
    fd.append("OrgCode",  payload.OrgCode); // ✅ Required — Swagger shows OrgCode field
    ...
    const res = await fetch(`${baseUrl}/api/Organization/organizationLogin`, {
        ...
        headers: {
            ...
            "X-API-KEY":    apiKey,
            "X-ADMIN-CODE": "2", // Service-provider portal uses code 2
        },
        body: fd,
    });
