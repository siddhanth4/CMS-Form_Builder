...
export default function SubmissionsReport() {
    ...
    const renderResponseData = (data: any) => {
        if (!data?.fields) return <div className="text-secondary">No structured data</div>;
            ...
            <div className="row g-0">
                ...
                <div className="panel mb-3">
                    <div className="panel-head p-3 d-flex justify-content-between">
                        <div className="h5">Form Responses</div>
                ...
                <div className="panel">
                    ...
                    <div className="p-3">
                        ...
                        {formResponsesLoading && <div>Loading...</div>}
                        {formResponsesError && <div className="text-danger">{formResponsesError}</div>}
