...
// src/Organization/organizationLogin.tsx
// Service Provider login page — uses /api/Organization/organizationLogin
// OrgCode for this portal is the service-provider's own org code (stored in context after first login,
// or hardcoded as the SP's fixed code via env var VITE_SP_ORG_CODE).
...
export default function OrganizationLogin({ onForgotPassword }: Props) {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // ✅ Service-provider portal uses its own fixed OrgCode.
            //    VITE_SP_ORG_CODE should be set in your .env file (e.g. VITE_SP_ORG_CODE=2).
            //    Fallback to "2" which is the X-ADMIN-CODE already used by all Org API calls.
            const spOrgCode = import.meta.env.VITE_SP_ORG_CODE ?? "2";
